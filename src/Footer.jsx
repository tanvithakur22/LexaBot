...
const Footer = () => {
  return (
    <footer className="bg-rgb(16, 25, 46) text-white py-4 text-center shadow-lg w-full">
      ...
      <h1 className="text-2xl font-bold text-center">LexaBot</h1>
        
        <div className="flex justify-center space-x-4 mb-3">
          <a
            href="https://github.com/tanvithakur22"
          ...
          <a
            href="https://www.linkedin.com/in/tanvithakur22/"
            className="text-blue-400 hover:text-white transform hover:scale-110 transition duration-300 flex items-center"
          >
            <FaRocket className="mr-1" /> Contact Now
          </a>
        </div>
        <p className="text-xs text-gray-500">&copy; 2025 LexaBot. All rights reserved.</p>
      </div>
    </footer>
  );
};
